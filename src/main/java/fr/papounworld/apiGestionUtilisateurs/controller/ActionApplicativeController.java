...
public class ActionApplicativeController {
	...
	public Iterable<ActionApplicative> getActionsApplicative() {
		return actionApplicativeService.getActionsApplicative();
	}
	...
	/*
	 * @PostMapping("/actionapplicative") public ActionApplicative
	 * createActionApplicativeScript(@RequestBody ActionApplicative
	 * actionApplicative) {
	 * 
	 * return actionApplicativeService.saveActionApplicative(actionApplicative); }
	 * 
	 * @PutMapping("/actionapplicative/{id}") public ActionApplicative
	 * updateActionsApplicative(@PathVariable("id") final Long id,
	 * 
	 * @RequestBody ActionApplicative actionApplicativeBody) {
	 * 
	 * Optional<ActionApplicative> optionalActionsApplicativeUrl =
	 * actionApplicativeService.getActionApplicative(id); if
	 * (optionalActionsApplicativeUrl.isPresent()) { ActionApplicative
	 * actionApplicativeUrl = optionalActionsApplicativeUrl.get(); if
	 * (actionApplicativeBody.getLibelle() != null) {
	 * actionApplicativeUrl.setLibelle(actionApplicativeBody.getLibelle()); }
	 * 
	 * actionApplicativeService.saveActionApplicative(actionApplicativeUrl); return
	 * actionApplicativeUrl; } else {
	 * 
	 * return null; } }
	 * 
	 * @DeleteMapping("/actionapplicative/{id}") public void
	 * deleteActionsApplicative(@PathVariable("id") final Long id) {

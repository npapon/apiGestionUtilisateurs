...
public class InformationsPersonnellesUtilisateurController {
	...
	public InformationsPersonnellesUtilisateur getInformationPersonnellesUtilisateur(@PathVariable("id") final Long id) {
		Optional<InformationsPersonnellesUtilisateur> informationsPersonnellesUtilisateurOptional = informationsPersonnellesUtilisateurService.getInformationPersonnellesUtilisateur(id);
	...
	public InformationsPersonnellesUtilisateur createInformationPersonnellesUtilisateur(@RequestBody InformationsPersonnellesUtilisateur informationsPersonnellesUtilisateur) {
		return informationsPersonnellesUtilisateurService.saveInformationPersonnellesUtilisateur(informationsPersonnellesUtilisateur);
	}
	...
	public InformationsPersonnellesUtilisateur updateInformationPersonnellesUtilisateur(@PathVariable("id") final Long id,  @RequestBody  InformationsPersonnellesUtilisateur informationsPersonnellesUtilisateurBody) {
		
		Optional<InformationsPersonnellesUtilisateur> informationsPersonnellesUtilisateurOptionalUrl = informationsPersonnellesUtilisateurService.getInformationPersonnellesUtilisateur(id);
		if(informationsPersonnellesUtilisateurOptionalUrl.isPresent())
		{
			InformationsPersonnellesUtilisateur informationsPersonnellesUtilisateurUrl = informationsPersonnellesUtilisateurOptionalUrl.get();
			...
			{informationsPersonnellesUtilisateurUrl.setTelephone(informationsPersonnellesUtilisateurBody.getTelephone());}
